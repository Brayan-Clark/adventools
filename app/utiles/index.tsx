...
export default function UtilesIndex() {
  ...
  const RESOURCES = [
    ...
    },
    {
      ...
      subtitle: "Fitoriana, Tanambinana, etc.",
    ...
    {
      id: 'themes-divers',
      title: "Thèmes Divers & Versets",
      subtitle: "Sabata, Ravaka, Fahendrena...",
  ...
  return (
    <SafeAreaView className="flex-1 bg-background-dark">
      ...
      <View className="px-6 py-4 flex-row items-center border-b border-white/5">
        ...
        <View>
          <Text className="text-xl font-bold text-white" style={{ fontFamily: 'Lexend_700Bold' }}>Utiles</Text>
          <Text className="text-slate-500 text-xs">Ressources et listes d'étude</Text>
        </View>
      </View>
      ...
      <ScrollView className="flex-1 px-6 pt-6" showsVerticalScrollIndicator={false}>
        ...
        <View className="bg-slate-900 border border-slate-800 rounded-[32px] p-6 mb-8 overflow-hidden">
          ...
          <Text className="text-primary font-bold mb-2">Notes Personnalisées</Text>
          <Text className="text-slate-400 text-xs leading-5">Retrouvez ici les thèmes et versets regroupés pour vos moments d'étude et de partage.</Text>
        </View>

        <Text className="text-[10px] font-bold text-slate-500 uppercase tracking-[0.2em] mb-4 ml-1">Dossiers</Text>
