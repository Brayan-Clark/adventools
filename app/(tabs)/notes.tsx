...
const TEXT_COLORS = []; // Désactivé (Utilisez le surlignage)
...
export default function Notes() {
  ...
  const markdownStyles = {
    ...
    code_inline: { backgroundColor: '#1e293b', color: '#60a5fa', paddingHorizontal: 6, paddingVertical: 2, borderRadius: 6, fontFamily: 'SpaceMono_400Regular' },
    code_block: { backgroundColor: '#0f172a', color: '#e2e8f0', padding: 20, borderRadius: 16, marginVertical: 12, borderLeftWidth: 4, borderLeftColor: '#3b82f6', fontFamily: 'SpaceMono_400Regular' },
    fence: { backgroundColor: '#0f172a', color: '#e2e8f0', padding: 20, borderRadius: 16, marginVertical: 12, borderLeftWidth: 4, borderLeftColor: '#3b82f6', fontFamily: 'SpaceMono_400Regular' },
  };
