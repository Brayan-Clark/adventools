...
export interface TranslationSchema {
  ...
  language: string;
  study_reminder_group: string;
  enable_reminder: string;
  reminder_time: string;
  warn_in_advance: string;
  exact_time: string;
  minutes_before: string;
  study_reminder_setup: string;
  study_reminder_step1: string;
  study_reminder_step2: string;
  study_reminder_step3: string;
  study_reminder_setup_desc: string;
  custom_lead_time: string;
  no_warning: string;
  no_warning_desc: string;
